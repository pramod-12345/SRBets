...
const Modal = ({ onClose, children }) => {
  ...
  return (
    <div className="fixed inset-0 flex z-20 items-center justify-center bg-black bg-opacity-80">
      <div className="max-w-[600px] w-full mx-5 lg:mx-auto my-auto h-auto rounded-[20px] overflow-auto no-scrollbar">
        <div className="max-w-[600px] w-full mx-auto max-h-[90vh] bg-blackRussian rounded-[20px] md:p-8 pb-4 text-white relative h-auto overflow-auto">
