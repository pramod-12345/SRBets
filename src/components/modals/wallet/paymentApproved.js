    ...
    <div className="relative">
      ...
      <div className="p-4 pt-5 md:p-0 h-[80vh] md:h-auto">
        ...
        <div className=" px-0 md:px-0 py-3 md:py-0 pt-10 md:pt-10  md:h-auto">
          ...
          {/* <!-- Action Buttons --> */}
          <div class="absolute md:static bottom-6 left-0 right-0 space-y-6 w-full px-4 md:px-0 md:mt-24">
            <CommonButton
              label={"Close"}
              type="viewBetsBtn"
              onClick={closeModal}
            />
            <button class="w-full py-3.5 bg-darkByzantineBlue font-semibold text-white rounded-lg">
