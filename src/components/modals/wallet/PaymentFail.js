        ...
        <Modal>
            <div className="flex items-center justify-center bg-blackRussian">
                <div className="w-full">
                    <div className="flex bg-richBlack h-[340px] rounded-2xl pt-10 flex-col items-center justify-center">
                        ...
                        <div className='flex flex-col justify-center items-center mt-4'>
                            ...
                            <Typography variant={"size14Medium"} color={"white"} content={"Payment of $500 failed due to technical reasons"} />
                            </div>
                            <div className='mt-3'>
