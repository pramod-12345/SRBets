...
const RegisterTerms = () => {
    ...
    return (
            <div className="w-full">
                ...
                <p className="text-vintageRibbon text-[16px] mt-5 md:mt-0 leading-[21px] font-medium">
                    Read and accept the terms & conditions
                </p>

                {/* Content */}
                <div className="space-y-6 mt-10 max-h-[500px] w-fit whitspace-wrap overflow-y-auto scrollbar-thin">
                    <section>
