...
import { toasterCheck, toasterClose, toasterSlip, toasterFail } from "assets";

export const ToastError = ({ message, onClose, duration = 5000 }) => {
    ...
    <div className="fixed top-5 w-full flex items-start justify-center z-50">
      <div className="relative flex gap-6 items-center max-w-[560px] w-full px-5 py-4 bg-darkByzantineBlue rounded-2xl">
        ...
        <div className="absolute top-2.5 right-2.5">
          <CommonButton
            label={
              <img src={toasterClose} alt="Toast Close" className="w-6 h-6" />
            }
            type="toasterClose"
          />
        </div>
